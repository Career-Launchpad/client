...
const introDialogPrompt =
  "Your school has requested that you input information " +
  'regarding your job hunt. Please click "BEGIN" to continue. Your information ' +
  "will be used in accordance with [our privacy policy](/privacy-policy). By " +
  "proceeding, you agree to the terms of said policy.";

const IntroDialog = ({ onSubmit }) => (
  <Dialog onSubmit={onSubmit} prompt={introDialogPrompt} submitText="Begin" />
);
