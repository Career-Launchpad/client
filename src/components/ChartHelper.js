...
const ChartHelper = ({ data, labels, title, type, pointLabel, backgroundColor, borderColor, hoverBorderColor, fillText }) => {
    useEffect(() => {
        buildChart();
    });
...
const doughnutPostSetup = (chart, fillText) => { // TODO: Need eyes on this, for some reason, it's not working
